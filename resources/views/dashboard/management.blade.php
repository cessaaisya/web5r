...
<head>
    ...
    <title>Management Dashboard - 5R Analysis Report for Toyota</title>
            ...
            <div class="px-4 py-6 sm:px-0">
                ...
                <div class="mt-8 bg-white shadow rounded-lg border-2 border-maroon">
                    <div class="px-4 py-5 sm:p-6">
                        <h3 class="text-lg leading-6 font-medium text-maroon mb-4">Management Overview</h3>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div class="text-center">
                                <div class="text-2xl font-bold text-maroon">{{ $activeUsers }}</div>
                                <div class="text-sm text-black">Active Students</div>
                            </div>
                            <div class="text-center">
