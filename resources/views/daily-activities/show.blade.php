            ...
            <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-2 items-center">
                        <a href="{{ route('daily-activities.edit', $dailyActivity) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-2 sm:px-4 rounded flex items-center">
